...
function draw() {
    ...
    if(gameState == "ENtutorial") {
        ...
        displayWidth / 2 -650, displayHeight / 2 -240);
        text("If they make it, it'll start receiving damage. If it gets to 0% the game will have finished!", 
        displayWidth / 2 -624, displayHeight / 2 -210);
    ...
    if(gameState == "fight") {
        ...
        if(language == "SP") {
            ...
            if(timer1 > 1) {
                text("Time left to use 'Shockwave' (Letter O): " + timer1 + " seconds", displayWidth / 2 +170, 
                displayHeight / 2 +375);
            }
            else if(timer1 == 1) {
                text("Tiempo left to use 'Shockwave' (Letter O): " + timer1 + " second", displayWidth / 2 +170, 
                displayHeight / 2 +375);
            }
            else if(timer1 == 0) {
                text("Time left to use 'Shockwave' (Letter O): " + timer1 + " seconds", displayWidth / 2 +170, 
